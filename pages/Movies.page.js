      ...
      <div>
         <div className="relative flex w-full flex-col items-center bg-navCol-700 shadow-2xl shadow-black">
            ...
            <div className="mr-8 mobile:mb-10 lg:mb-1 mobile:mr-0 text-white bg-navCol-700 lg:pb-20 p-4 shadow-2xl shadow-black">
               <YTMovie key={currentMovieDetail.id}/>
                     ...
                     <>
                        {
                           ...
                           <span className="w-44 flex flex-col items-center justify-around mb-8 p-5 shadow-2xl rounded-3xl mr-2">
                              <img className=" p-3" src={"https://image.tmdb.org/t/p/original" + company.logo_path} alt="Movie company logo" />
